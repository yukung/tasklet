...
/**
 * <p>
 * アクティビティEntityから、アクティビティ並び替え画面DTOへの変換を行います。
 * </p>
 * 
 * @author yukung
 * 
 */
public class SortableConverter implements DtoConverter<Activity, SortableDto> {
	 ...
	 */
	@Override
	public SortableDto convert(Activity entity) {
	 ...
	 */
	@Override
	public List<SortableDto> convert(List<Activity> entities) {
		List<SortableDto> list = new ArrayList<SortableDto>();
